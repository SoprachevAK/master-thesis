...
==== MazeMap
MazeMap -- работает в формате SAAS (Software as a Service), то есть, предоставляет готовое решение для размещения карт.
...
- Настроенные ESLint для оценки качества кода, подробнее в @code-quality-check
