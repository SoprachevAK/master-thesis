...
Рассмотрим каждый их них подробнее с точки зрения пригодности для PolyMap, в частности нас интересует поддержка веб тестирования, компонентного для VueJS, возможность запуска тестов в Github CI/CD.
