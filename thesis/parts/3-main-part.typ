...
С использованием цен актуальных на момент написания работы (@serverless-price) можно ориентировочно рассчитать общие затраты на инфраструктуру в месяц.

// TODO: Расчёт затрат на инфраструктуру в месяц
// TODO: Картинка со стоикостью инфраструктуры на кубере
