...
#todo[Добавить пример кода Terraform]
...
#todo[Скриншот пайплайна и поверхностно рассказать о всех шагах и жизненном цикле, после чего, шаги раскрыть отдельными подразделами]
