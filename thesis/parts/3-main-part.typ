...
// TODO: Общая схема архитектуры приложения (типа клиент ходит к серверу, сервер в бд)
== Клиентская часть
...
// TODO: Детальная схема архитектуры приложения
...
+ Низкая стоимость – Serverless распространяется по модели pay-as-you-go, то есть необходимо оплачивать только те ресурсы, которые были фактически использованы. Это позволяет значительно снизить затраты на инфраструктуру.

// TODO: График serverless vs Kubernetes
...
// TODO: Сравнительная таблица функционала облачных провайдеров в области Serverless и баз данных

Как видно из таблицы, наибольшим требуемым функционалом обладает Яндекс Облако, поэтому оно было выбрано в качестве облачного провайдера для проекта.
...
// TODO: Картинка работы CDN (как летят запросы пользователей)
...
// TODO: Картинка жизненного цикла запроса (DNS -> CDN -> API Gateway -> Serverless Container -> YDB -> CDN -> Пользователь)
...
// TODO: Добавить таблицу с ценами на ресурсы и бесплатными квотами
