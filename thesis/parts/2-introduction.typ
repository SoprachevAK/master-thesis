...
== Постановка задачи
Пилотная версия PolyMap показала свою актуальность и востребованность среди студентов, однако в её реализации существует ряд ограничений:
