...
Всего за этот учебный год, аннотации открывали 6525 пользователей. Согласно статистике СПбПУ (https://www.spbstu.ru/university/strategy-development/the-university-in-numbers/), в университете очно обучается 24 тысячи студентов. По статистике Т-Банка (https://www.spbstu.ru/university/strategy-development/the-university-in-numbers/), доля iOS пользователей в Санкт-Петербурге составляет 49%. Таким образом, число студентов, у которых есть iOS устройство, можно оценить в 12 тысяч. Из этого можно сделать вывод, что каждый второй студент среди тех, кто мог воспользоваться PolyMap, воспользовался им. Это говорит о том, что приложение востребовано среди студентов и активно используется. При этом, стоит отметить, что в приложении присутствуют не все корпуса, и для студентов некоторых институтов, приложение может быть не актуально.
...
+ Просмотр карт должен быть доступен без установки приложения, в виде веб-приложения, которое будет работать в браузере.
